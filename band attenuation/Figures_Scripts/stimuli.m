...
% Attenuation
SimParams.Attenuate.beta    = 1;                    % Attenuation smoothness factor
SimParams.Attenuate.f_1     = floor(inputs/4);      % Attenuation start index
SimParams.Attenuate.f_2     = floor(inputs*3/4);    % Attenuation end index
