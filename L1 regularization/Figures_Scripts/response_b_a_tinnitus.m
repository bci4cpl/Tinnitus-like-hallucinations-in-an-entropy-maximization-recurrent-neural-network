...
if (isloaded)
    ...
    if (isstruct(tmp))
        ...
        sig = SimParams.Attenuate.minval + (1 - SimParams.Attenuate.minval) * (1 ./ (1 + exp(- SimParams.Attenuate.beta .* (SimParams.Attenuate.f_0 - x_sig))));
